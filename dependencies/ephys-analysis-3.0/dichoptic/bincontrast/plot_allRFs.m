...
didir = 'C:\Users\bmitc_000\Documents\MATLAB\workspaces\';
savedir = 'C:\Users\bmitc_000\Documents\MATLAB\workspaces\RFtest\'; 

load([didir 'bincontrast_workspace.mat']);
...
for i = 1:length(pen)
    ...
    for un = 1:length(units)
        ...
        if ~kls
            ...
            goodfiles = STIM.units(un).fileclust(:,1);  % already e
        ...
        if any(diff(goodfiles) > 1)
            ...
            continue %DEV: need to figure out a way to salvage
        end
