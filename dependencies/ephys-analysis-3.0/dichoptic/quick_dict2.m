...
varsavepath  = sprintf('/Volumes/Drobo2/USERS/Michele/Dichoptic/DiStim_AutoNev_Aug10b/')
...
skipct = 0; SKIPPED ={};
uct = 0; clear IDX
for s = 22%length(TuneList.Penetration):-1:0 %length(TuneList.Penetration)-1
