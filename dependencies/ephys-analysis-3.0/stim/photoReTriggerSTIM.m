function [newTP,trigger] = photoReTriggerSTIM(TP,filename,ypos,trigger)
...
if contains(brpath,'CRF')
    switch BRdatafile
        case {'151205_E_rfori002','151205_E_rfori003','151205_E_cosinteroc001'}
            bhvfile =  'T:\diSTIM - adaptdcos&CRF\Neurophys Data\151205_E\151205_E_rfori005.bhv';
        case '161005_E_rfori001'
            bhvfile = 'T:\diSTIM - adaptdcos&CRF\Neurophys Data\161005_E\161005_E_rfori002.bhv';
        case '161006_E_evp001'
            bhvfile = 'T:\diSTIM - adaptdcos&CRF\Neurophys Data\161006_E\161006_E_rfori001.bhv';
        case '170724_I_evp003'
            bhvfile = 'T:\diSTIM - adaptdcos&CRF\Neurophys Data\170724_I\170724_I_rfori002.bhv';
        otherwise
            bhvfile = [filename '.bhv'];
    end
elseif strfind('drobo',brpath)
    ...
    switch BRdatafile
        ...
        case '170724_I_mcosinteroc001'
            bhvfile =  '/Volumes/Toshiba External/170724_I_rfori002.bhv';
        case '211014_T_rfori001' 
            bhvfile = [filename '.bhv2'];
        otherwise
            bhvfile = [filename '.bhv']; % BM, changed .bhv2. 
...
refresh   =  ceil((1/bhv.ActualVideoRefreshRate) * Fs); % time for a screen refresh in sampels * needs hard code
