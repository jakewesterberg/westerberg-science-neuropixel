...
[ontarget,rt] = eyejoytrack('acquirefix', fixation_point, fix_rect, wait_for_fix);
if ~ontarget
...
if 0==error_type
    ...
    chosen_target = eyejoytrack('acquirefix', [target distractor], [fix_rect; fix_rect], max_reaction_time);
    if ~chosen_target
