...
% The 1st column is MGL object IDs, which can be accessed by TaskObject.ID(TaskObject#).
% The 2nd column is image positions in visual angles.
% The 3rd column is image durations.
% The 4th column is eventmarkers.
img1.ImageList = { TaskObject.ID([2 4]), [5 5; -5 -5], 2000, 101; ...  % A & C
    '', [], 2000, 100; ...
    TaskObject.ID([3 5]), [5 -5; -5 5], 2000, 102; ...  % B & D
    '', [], 2000, 100; ...
    TaskObject.ID([2 4]), [-5 -5; 5 5], 2000, 103; ...  % A & C
    '', [], 2000, 100; ...
    TaskObject.ID([3 5]), [-5 5; 5 -5], 2000, 104;      % B & D
    '', [], 2000, 100; };
