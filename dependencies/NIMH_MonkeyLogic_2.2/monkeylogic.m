...
%         set(hTag.MinifyRuntime,'value',MLConfig.MinifyRuntime);
    ...
    function DlgOtherDeviceSettings()
        ...
        eyeid = {'None',''; 'My EyeTracker','myeye'; 'Arrington ViewPoint EyeTracker','viewpoint'; 'SR Research EyeLink','eyelink'; 'ISCAN Eye Tracker','iscan'; 'Thomas RECORDING TOM-rs','tomrs'}; eyeid = eyeid([true; ismember(eyeid(2:end,2),mdqmex(20,1,2))],:);
    ...
    function init()
        ...
        addpath(MLPath.BaseDirectory,[MLPath.BaseDirectory 'daqtoolbox'],[MLPath.BaseDirectory 'mgl'],[MLPath.BaseDirectory 'ext'], ...
