classdef mlscreen_playback < handle
    ...
    methods
        ...
        function create(obj,MLConfig)
            ...
            mglcreateplaybackscreen(obj.SubjectScreenFullSize,obj.BackgroundColor,Pos2Rect([controlscreenposition(1:2)-1 0 0]+replica_pos),[0.25 0.25 0.25]);
            ...
            mglactivategraphic([obj.MouseCursor obj.ButtonLabel obj.ButtonPressed obj.ButtonReleased obj.TTL(:)' obj.Stimulation(:)'],false);
            
            reposition_tracers(obj,MLConfig);
            update_tracers(obj,MLConfig);
        end
        function reposition_tracers(obj,MLConfig)
        ...
        function update_tracers(obj,MLConfig)
            ...
            obj.TouchCursor = NaN(1,max(2,MLConfig.Touchscreen.NumTouch));
            for m=1:length(obj.TouchCursor), obj.TouchCursor(m) = load_cursor(MLConfig.TouchCursorImage,MLConfig.TouchCursorShape,MLConfig.TouchCursorColor,MLConfig.TouchCursorSize,10); end
