classdef RunSceneParam < matlab.mixin.Copyable
    ...
    methods
        function obj = RunSceneParam(MLConfig)
            ...
            if exist('MLConfig','var'), obj.SampleInterval = 1000 / MLConfig.AISampleRate; else, obj.SampleInterval = 1; end
        end
        function reset(obj)
        ...
        function stimfile(obj,val), for m=1:numel(val), obj.StimulusFile{end+1} = val{m}; end, end
