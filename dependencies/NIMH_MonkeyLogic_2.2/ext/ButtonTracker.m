classdef ButtonTracker < mltracker
    ...
    methods
        function obj = ButtonTracker(MLConfig,TaskObject,CalFun,DataSource)
            ...
            if 1==DataSource, obj.ButtonsAvailable = 1:MLConfig.DAQ.nButton; else, obj.ButtonsAvailable = obj.DAQ.buttons_available; end
    ...
    methods (Access = protected)
        ...
        function rebuild_button(obj,button)
            ...
            for m=button(:)'
                if obj.Invert(m)
                    mglsetproperty(obj.Screen.ButtonPressed(m),'bitmap',mglimresize(red_pressed,obj.Screen.DPI_ratio));
                    mglsetproperty(obj.Screen.ButtonReleased(m),'bitmap',mglimresize(red_released,obj.Screen.DPI_ratio));
                else
