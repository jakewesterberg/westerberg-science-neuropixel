classdef mltrialrecord < handle
    ...
    methods (Hidden)
		function next_block(obj,val), obj.NextBlock = val; end
        function next_condition(obj,val), obj.NextCondition = val; end  % ignored in case of the conditions file
