...
strText = '';
switch hook
    case 'task_start', strText = [strTime SubjectName ' just started Task ''' CondFile '''.'];
    ...
    case 'task_end', strText = [strTime SubjectName ' finished Task ''' CondFile '''.'];
        
    case 'task_aborted', strText = [strTime 'An error occurred while ' SubjectName ' was doing Task ''' CondFile '''.'];
