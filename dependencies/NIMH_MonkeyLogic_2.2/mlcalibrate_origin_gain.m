...
% end of the dialog
    ...
    function init()
        ...
        if DAQ.reward_present
            ...
            mglsetproperty(reward_duration_id,'origin',[10 10]*Screen.DPI_ratio,'fontsize',12);
            mglsetproperty(mgladdtext('+/-: Increase/decrease reward by 10 ms',12),'origin',[10 30]*Screen.DPI_ratio,'fontsize',12);
        end
    ...
    function update_fixpoint()
        ...
        mgldestroygraphic(trial_count_id(1));
        ...
        trial_count_id(1) = mgladdbitmap(imdata,12);
    end
