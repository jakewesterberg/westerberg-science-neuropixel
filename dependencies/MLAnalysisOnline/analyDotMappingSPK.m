clear
BRdatafile = '160908_E_dotmapping002';
el = 'eD';
el_array = [6:20]; 
...
flag_plotNS2 = true; % set to true to get a RFmap from LFP power, requires NS2, SLOW
...
if ispc
    ...
    brdrname = sprintf('/Volumes/Drobo2/DATA/NEUROPHYS/rig%s/%s',rignum,BRdatafile(1:8));    mldrname = brdrname;
end
